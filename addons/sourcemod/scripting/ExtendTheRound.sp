...
public void OnPluginStart()
{
    ...
    gc_iMode = AutoExecConfig_CreateConVar("sm_er_mode", "1", "Режим работы плагина, всего 2 режима: 0 - Плагин будет учитывать всех игроков на сервере (спектаторы в том числе и люди, которые подключаются к серверу), 1 - только игроков, которые находятся в команде T / CT", 0, true, 0.0, true, 1.0);
